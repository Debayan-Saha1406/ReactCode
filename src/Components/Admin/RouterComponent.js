      ...
      <BrowserRouter>
        <Switch>
          ...
          <Route
            ...
            render={() => (
              <Admin subRoute={route.movie} subChildRoute={route.addMovie} />
            )}
          />
          <Route
          ...
          <Route
            ...
            render={() => (
              <Admin subRoute={route.movie} subChildRoute={route.viewMovies} />
            )}
          />
          <Route
          ...
          <Route
            ...
            render={() => (
              <Admin subRoute={route.movie} subChildRoute={route.editMovies} />
            )}
          />
